...
public static class DbInitializer
{
    ...
    private static void InsertPies(BethanysPieShopDbContext context)
    {
        Dictionary<string, Category> categories = context.Categories.ToDictionary(c => c.CategoryName);
        context.AddRange(GetPies(categories).Select(p => p));
    }

    private static Pie[] GetPies(Dictionary<string, Category> categories)
    {
        return new[]
        {
            new Pie
            {
                ...
                CategoryId = categories["Cheese cakes"].CategoryId,
                ImageUrl =
            ...
            new Pie
            {
                ...
                CategoryId = categories["Fruit pies"].CategoryId,
                ImageUrl =
            ...
            new Pie
            {
                ...
                CategoryId = categories["Seasonal pies"].CategoryId,
                ImageUrl =
    ...
    private static void InsertCategories(BethanysPieShopDbContext context)
    {
        context.Categories.AddRange(GetCategories().Select(c => c));
    }
}